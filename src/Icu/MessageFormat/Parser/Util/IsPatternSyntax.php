 ...
 * @internal
 */
class IsPatternSyntax extends AbstractCodePointMatcher
{
    /**
     * Pattern syntax code points
     *
     * This list is derived from the Pattern_Syntax code points listed in the
